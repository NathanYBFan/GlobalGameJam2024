...
namespace Editor.Editor
{
    public static class UnityEditorBackgroundColour
    {
        ...
        private static readonly Color kSlelectedProColour = new(0.1725f, 0.3647f, 0.5294f);
        
        private static readonly Color kSelectedUnFocusedColour = new(0.68f, 0.68f, 0.68f);
        private static readonly Color kSlelectedUnFocusedProColour = new(0.3f, 0.3f, 0.3f);
        ...
        public static Color Get(bool isSelected, bool isHovered, bool isWindowFocused)
        {
            ...
            {
                if (isWindowFocused)
                    return EditorGUIUtility.isProSkin ? kSlelectedProColour : kSelectedColour;
                return EditorGUIUtility.isProSkin ? kSlelectedUnFocusedProColour : kSelectedUnFocusedColour;
            }
