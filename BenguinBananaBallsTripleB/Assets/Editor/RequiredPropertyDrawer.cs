...
namespace Editor.Editor
{
    ...
    public class RequiredPropertyDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            if (property.propertyType != SerializedPropertyType.ObjectReference || property.objectReferenceValue != null) return;
            ...
            Rect helpBoxPosition = new(position.x, position.y + EditorGUIUtility.singleLineHeight + 2f, position.width, EditorGUIUtility.singleLineHeight);
            EditorGUI.HelpBox(helpBoxPosition, ObjectNames.NicifyVariableName(property.name) + " is required!", MessageType.Error);
        
            GUI.backgroundColor = previousColour; // Restore the previous background color
        
            // TODO: Consider adding a button or option to automatically assign a default value if one exists.
        }
    }
}
#endif